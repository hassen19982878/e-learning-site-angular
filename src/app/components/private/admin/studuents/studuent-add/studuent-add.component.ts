...
@Component({
  selector: 'app-studuent-add',
  templateUrl: './studuent-add.component.html',
  styleUrls: ['./studuent-add.component.css','./../../../../../../assetsadmin/css/sb-admin-2.css']
})
export class StuduentAddComponent implements OnInit {
