...
@Component({
  selector: 'app-studuent-update',
  templateUrl: './studuent-update.component.html',
  styleUrls: ['./studuent-update.component.css','./../../../../../../assetsadmin/css/sb-admin-2.css']
})
export class StuduentUpdateComponent implements OnInit {
